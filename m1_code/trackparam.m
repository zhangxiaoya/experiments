...
switch (title)
    ...
    case 'girl'; p =   [180,109,104,127,0];
        opt = struct('numsample',200, 'affsig',[10,10,.08,.00,.000,.000]);
        forMat = '.jpg';
    ...
    case 'stone'; p = [115 150 43 20 0.0];
        ...
        opt = struct('numsample',400, 'affsig',[8,8,.000,.000,.000,.000]);
        forMat = '.jpg';
        
        case 'football';p = [330 125 50 50 0.00];
        opt = struct('numsample',100,'affsig',[4, 4, 0.01, .00, .00, .00]);
        forMat = '.jpg';
        
        case 'bolt';  
        p = [ 349 195.5 26 61 0];
        opt = struct('numsample',100, 'affsig',[4,4,.01,.000,.000,.000]);
        forMat = '.jpg';
